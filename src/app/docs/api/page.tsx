  ...
  return (
    ...
    >
      ...
      <DocsSection id="create" title="POST /payments/charge" description="Cria um PaymentIntent idempotente e resolve Store → policy → provider → economics → release.">
        ...
        <div className="mt-4 rounded-2xl border border-[#20F29A]/16 bg-[#20F29A]/4 p-4 text-[9px] leading-5 text-[#82AA9D]">
          <strong className="text-[#79D8B8]">Produção:</strong> quando o status for <InlineCode>PENDING_PAYMENT</InlineCode>, utilize <InlineCode>action.copyPaste</InlineCode> e/ou <InlineCode>action.qrCode</InlineCode>. A confirmação final deve vir de <InlineCode>payment.succeeded</InlineCode> ou da consulta de status.
        </div>
      </DocsSection>
