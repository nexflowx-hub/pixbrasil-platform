    ...
    >
      ...
      <DocsSection id="output" title="O que a IA deve devolver">
        <ul className="space-y-2 text-[9px] leading-5 text-[#78918A]">
          ...
          <li>• Pendências operacionais, de KYC/policy ou rollout que ainda precisem ser resolvidas.</li>
        </ul>
      </DocsSection>
    </DocsShell>
  );
