...
export default function DocsHomePage() {
  return (
    ...
    >
      <DocsSection id="status" title="Estado atual da plataforma" description="A API Merchant, routing, execução PIX, webhooks, settlement e Wallet BRL operam em produção.">
        <DocsGrid>
          ...
          <DocsCard title="Provider execution" tone="green">
            ...
            <p className="mt-2">Stores ativas criam cobranças PIX reais no provider definido pelo routing.</p>
          </DocsCard>
          <DocsCard title="Payouts & settlement" tone="green">
            <div className="flex items-center gap-2 text-[#79D8B8]"><CheckCircle2 className="h-3.5 w-3.5" /> Produção</div>
            <p className="mt-2">Settlement e liberação alimentam a Wallet BRL; payouts são processados por ticket operacional nesta fase.</p>
          </DocsCard>
        </DocsGrid>
      </DocsSection>
