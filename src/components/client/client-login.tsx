        ...
        <section className="hidden border-r border-white/8 px-10 py-12 lg:flex lg:flex-col lg:justify-between xl:px-16">
          ...
          <div className="max-w-xl pb-10">
            ...
            <p className="mt-6 max-w-lg text-[15px] leading-7 text-[#8FA7A1]">
              Acesse contas Personal e Business, wallets, Stores e atividade a partir do mesmo portal. Cobranças PIX, Stores, saldos e Tesouraria são operados pelo PiXBrasil Financial Core.
            </p>
          </div>
