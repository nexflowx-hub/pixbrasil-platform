...
const content = {
  personal: {
    ...
    title: "Controle financeiro digital numa única experiência.",
    description:
      "O Client Portal reúne conta, identidade, wallets e atividade numa interface única. As capacidades disponíveis seguem a política e os ativos habilitados em cada conta.",
    icon: UserRound,
    capabilities: [
      ...
      ["Receber via PIX", "AVAILABLE", "Recebimento disponível conforme produto e política da conta."],
      ["Enviar / Withdraw", "AVAILABLE", "Saídas disponíveis nos ativos e métodos habilitados."],
      ["Conversão", "ROADMAP", "Conversão multiativo será habilitada progressivamente."],
    ],
    highlights: [
          ...
          <div className="rounded-[28px] border border-white/9 bg-[#061416]/92 p-5 shadow-[0_30px_100px_rgba(0,0,0,.28)] sm:p-6">
            <div className="flex items-center justify-between border-b border-white/7 pb-4">
              <div>
                ...
                <strong className="mt-1 block text-[14px]">Estado da operação</strong>
              </div>
...
function StatusBadge({ value }: { value: string }) {
  ...
  const validating = value === "ROADMAP";
