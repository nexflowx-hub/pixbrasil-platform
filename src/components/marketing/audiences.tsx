  ...
  return (
    ...
    >
      ...
      <AudienceCard
        ...
        description="Integre API PIX, separe Stores por regra comercial e acompanhe pagamentos, liberações e Wallet BRL em uma única camada operacional."
